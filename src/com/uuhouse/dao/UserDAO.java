...
public class UserDAO {
	...
	public User findById(java.lang.Integer id) {
		...
		try {
			User instance = (User) getSession().get("com.uuhouse.dao.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = getSession().createCriteria("com.elmis.dao.User").add(Example.create(instance)).list();
